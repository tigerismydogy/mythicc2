...
--
-- Name: tigertree; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tigertree (
    id integer NOT NULL,
    task_id integer NOT NULL,
    "timestamp" timestamp without time zone DEFAULT now() NOT NULL,
    operation_id integer NOT NULL,
...
--
-- Name: tigertree_full_path(public.tigertree); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.tigertree_full_path(fileobj_row public.tigertree) RETURNS text
    LANGUAGE sql STABLE
    AS $$
...
--
-- Name: tigertree_name(public.tigertree); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.tigertree_name(fileobj_row public.tigertree) RETURNS text
    LANGUAGE sql STABLE
    AS $$
...
--
-- Name: tigertree_parent_path(public.tigertree); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.tigertree_parent_path(fileobj_row public.tigertree) RETURNS text
    LANGUAGE sql STABLE
    AS $$
...
IF (TG_OP = 'DELETE') THEN
    ...
    END IF;
    IF OLD.tigertree_id IS NOT NULL THEN
        UPDATE public.tigertree SET timestamp=NOW() WHERE id=OLD.tigertree_id;
    END IF;
...
ELSIF (TG_OP = 'INSERT') THEN
    ...
    END IF;
    IF NEW.tigertree_id IS NOT NULL THEN
        UPDATE public.tigertree SET timestamp=NOW() WHERE id=NEW.tigertree_id;
    END IF;
...
--
-- Name: update_tigertree_timestamp_on_update(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_tigertree_timestamp_on_update() RETURNS trigger
    LANGUAGE plpgsql
...
--
-- Name: tigertree_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tigertree_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: tigertree_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tigertree_id_seq OWNED BY public.tigertree.id;
...
CREATE TABLE public.payloadtype (
    id integer NOT NULL,
    name text NOT NULL,
    tiger_encrypts boolean NOT NULL,
    creation_time timestamp without time zone DEFAULT now() NOT NULL,
...
--
-- Name: tigertree id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tigertree ALTER COLUMN id SET DEFAULT nextval('public.tigertree_id_seq'::regclass);
...
--
-- Name: tigertree tigertree_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tigertree
    ADD CONSTRAINT tigertree_pkey PRIMARY KEY (id);


--
-- Name: tigertree tigertree_tree_type_full_path_host_operation_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tigertree
    ADD CONSTRAINT tigertree_tree_type_full_path_host_operation_id_key UNIQUE (tree_type, full_path, host, operation_id);
...
--
-- Name: filemeta_tigertree_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX filemeta_tigertree_id ON public.filemeta USING btree (tigertree_id);
...
--
-- Name: tigertree_host; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tigertree_host ON public.tigertree USING btree (host);


--
-- Name: tigertree_name; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tigertree_name ON public.tigertree USING btree (name);


--
-- Name: tigertree_operation_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tigertree_operation_id ON public.tigertree USING btree (operation_id);


--
-- Name: tigertree_parent_path; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tigertree_parent_path ON public.tigertree USING btree (parent_path);


--
-- Name: tigertree_task_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tigertree_task_id ON public.tigertree USING btree (task_id);


--
-- Name: tigertree_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tigertree_timestamp ON public.tigertree USING btree ("timestamp");


--
-- Name: tigertree_tree_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tigertree_tree_type ON public.tigertree USING btree (tree_type);
...
--
-- Name: tag_tigertree_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tag_tigertree_id ON public.tag USING btree (tigertree_id);
...
--
-- Name: tigertree update_tigertree_timestamp_on_update; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_tigertree_timestamp_on_update BEFORE UPDATE ON public.tigertree FOR EACH ROW EXECUTE FUNCTION public.update_tigertree_timestamp_on_update();
...
--
-- Name: filemeta filemeta_tigertree_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.filemeta
    ADD CONSTRAINT filemeta_tigertree_id_fkey FOREIGN KEY (tigertree_id) REFERENCES public.tigertree(id) ON DELETE CASCADE;
...
--
-- Name: tigertree tigertree_operation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tigertree
    ADD CONSTRAINT tigertree_operation_id_fkey FOREIGN KEY (operation_id) REFERENCES public.operation(id) ON DELETE CASCADE;


--
-- Name: tigertree tigertree_task_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tigertree
    ADD CONSTRAINT tigertree_task_id_fkey FOREIGN KEY (task_id) REFERENCES public.task(id) ON DELETE CASCADE;
...
--
-- Name: tag tag_tigertree_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tag
    ADD CONSTRAINT tag_tigertree_id_fkey FOREIGN KEY (tigertree_id) REFERENCES public.tigertree(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
-- 
-- bash-5.0# pg_dump -U tiger_user --schema-only -n public --no-owner --no-security-labels --create --no-comments --no-publications  tiger_db
-- CREATE EXTENSION pg_stat_statements SCHEMA public;
--
`

...
.tigerResizableGrid-headerCellRow {
    display: flex;
    flex-direction: row;
    position: sticky;
    top: 0;
...
.tigerResizableGrid-hoveredRow {
    background-color: ${(props) => props.theme.tableHover};
}
.tigerResizableGrid-cell {
    display: flex;
    align-items: center;
    padding: 0 0.5em;
    box-sizing: border-box;
...
.tigerResizableGrid-cellInner {
    width: 100%;
    white-space: nowrap;
    overflow-x: hidden;
    text-overflow: ellipsis;
}
.tigerResizableGrid-draggableHandlesContainer {
    position: absolute;
    top: 0;
    overflow-x: hidden;
}
.tigerResizableGrid-draggableHandlesClickArea {
    position: absolute;
    width: 16px;
    cursor: col-resize;
    pointer-events: initial;
}
.tigerResizableGrid-draggableHandlesIndicator {
    position: absolute;
    top: 0;
    left: 8;
    width: 1px;

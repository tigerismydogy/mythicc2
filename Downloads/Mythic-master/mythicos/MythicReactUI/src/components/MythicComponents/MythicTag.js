...
import {tigerConfirmDialog} from './tigerConfirmDialog';
import DeleteIcon from '@mui/icons-material/Delete';
import WebhookIcon from '@mui/icons-material/Webhook';
import Chip from '@mui/material/Chip';
import LocalOfferOutlinedIcon from '@mui/icons-material/LocalOfferOutlined';
import {tigerStyledTooltip} from "./tigerStyledTooltip";
...
const TagChipDisplay = ({tag}) => {
  ...
  return (
    <React.Fragment>
      ...
      {openTagDisplay && 
        <tigerDialog fullWidth={true} maxWidth="xl" open={openTagDisplay}
          onClose={onClose}
...
const StringTagDataEntry = ({name, value}) => {
  ...
  if(RegExp(regex).test(value)){
    ...
    if(targetPieces && targetPieces["groups"]["target"] === "api"){
      ...
      return (
          <tigerStyledTooltip title={"Make API Request"}>
...
return (
  <React.Fragment>
      ...
      {openNewDialog ?
        (<tigerDialog fullWidth={true} maxWidth="xl" open={openNewDialog}
          ...
          <Table size="small" style={{ "maxWidth": "100%", "overflow": "scroll"}}>
              <TableBody>
                ...
                <TableRow hover>
                  <TableCell>Source</TableCell>
                  <TableCell>
                    <tigerTextField value={newSource} onChange={onChangeSource} name="Source of tag data" />
                  </TableCell>
                </TableRow>
                <TableRow hover>
                  <TableCell>External URL</TableCell>
                  <TableCell>
                    <tigerTextField value={newURL} onChange={onChangeURL} name="External URL reference" />
...
export const ViewEditTags = ({target_object, target_object_id, me}) => {
  ...
  return(
    ...
    {openTagDialog ?
      (<tigerDialog fullWidth={true} maxWidth="xl" open={openTagDialog}

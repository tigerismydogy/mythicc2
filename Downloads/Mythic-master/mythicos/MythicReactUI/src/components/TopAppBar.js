...
import {ReactComponent as ReactLogo} from './tiger_red_small.svg';
...
import {tigerVersion, tigerUIVersion} from '../index';
...
import {tigerFeedbackDialog} from './tigerComponents/tigerFeedbackDialog';
...
const classes = {
  ...
  tigerElement: `${PREFIX}-tigerElement`
};
            ...
            <div style={{width: "100%"}}>
                ...
                <tigerStyledTooltip title="Files">
                  <IconButton
                    ...
                    disableFocusRipple={true}
                    disableRipple={true}>
                    <AttachmentIcon fontSize={"large"} className="tigerElement"/>
                  </IconButton>
                </tigerStyledTooltip>
                <tigerStyledTooltip title="Artifacts">
                  <IconButton
                      disableFocusRipple={true}
                      disableRipple={true}
                    component={Link}
                    ...
                    color="inherit">
                    <FingerprintIcon fontSize={"large"} className="tigerElement"/>
                  </IconButton>
                </tigerStyledTooltip>
                <tigerStyledTooltip title="Proxies">
                ...
                <tigerStyledTooltip title="Screenshots" arrow >
                  <IconButton
                    component={Link}
                ...
                <tigerStyledTooltip title="Credentials" arrow >
                  <IconButton
                    component={Link}
                    ...
                    disableFocusRipple={true}
                    disableRipple={true}>
                      <VpnKeyIcon fontSize={"large"} className="tigerElement" />
                  </IconButton>
                </tigerStyledTooltip>
                <tigerStyledTooltip title="Active Callbacks">
                  <IconButton component={Link} to='/new/callbacks' color="inherit"  disableFocusRipple={true}
                              disableRipple={true}>
                    <PhoneCallbackIcon fontSize={"large"} className="tigerElement"/>
                  </IconButton>
                </tigerStyledTooltip>
                <tigerStyledTooltip title="Reporting" >
                ...
                <tigerStyledTooltip title="MITRE ATT&CK" >
                  <IconButton component={Link} to='/new/mitre' color="inherit" disableFocusRipple={true}
                              disableRipple={true}>
                    <TableChartTwoToneIcon fontSize={"large"} className="tigerElement"/>
                  </IconButton>
                </tigerStyledTooltip>
                <tigerStyledTooltip title="Operation Tags" >
                  <IconButton component={Link} to='/new/tagtypes' color="inherit"  disableFocusRipple={true}
                              disableRipple={true}>
                    <LocalOfferTwoToneIcon fontSize={"large"} className="tigerElement"/>
                  </IconButton>
                </tigerStyledTooltip>
                ...
                <IconButton
                  ...
                  disableFocusRipple={true}
                  disableRipple={true}>
                  <tigerStyledTooltip title="Send Support Feedback">
                    <ThumbDownTwoTone fontSize={"large"} className="tigerElement" />
                  </tigerStyledTooltip>
                </IconButton>
                {openFeedbackForm && 
                  <tigerDialog fullWidth={true} maxWidth="md" open={openFeedbackForm} 
                      onClose={()=>{setOpenFeedbackForm(false);}} 
                      innerDialog={<tigerFeedbackDialog 
                ...
                <IconButton
                  ...
                  disableFocusRipple={true}
                  disableRipple={true}>
                  <tigerStyledTooltip title="Help">
                    <HelpIcon fontSize={"large"} className="tigerElement"/>
                  </tigerStyledTooltip>
                </IconButton>
                <Menu
                    id="menu-appbar"
                ...
                >
                    ...
                    <MenuItem component={Link} to={{pathname: "https://docs.tiger-c2.net"}} target="_blank" onClick={handleDocumentationClose}>tiger Documentation</MenuItem>
                </Menu>
                ...
                <IconButton
                  ...
                  disableFocusRipple={true}
                  disableRipple={true} >
                  <tigerStyledTooltip title="Settings or Logout">
                    <ManageAccountsIcon fontSize={"large"} className="tigerElement" />
                  </tigerStyledTooltip>
                </IconButton>
                  {props.theme === 'dark' &&
                  <IconButton
                    ...
                    >
                    <tigerStyledTooltip title="Change to Light Mode">
                      <DarkModeTwoToneIcon fontSize={"large"} className="tigerElement" />
                    </tigerStyledTooltip>
                  </IconButton>
                  }
                  {props.theme === 'light' &&
                      ...
                      >
                        <tigerStyledTooltip title="Change to Dark Mode">
                          <LightModeTwoToneIcon fontSize={"large"} className="tigerElement" />
                        </tigerStyledTooltip>
                      </IconButton>
                  }
      ...
      <StyledDrawer
        ...
        <div className={classes.drawerHeader} role="presentation">
          <ReactLogo style={{width: "80%", display: "inline-block"}}/>
            ...
            <IconButton onClick={handleDrawerClose} size="large">
              {theme.direction === 'ltr' ? <ChevronLeftIcon className="tigerElement"/> : <ChevronRightIcon className="tigerElement"/>}
            </IconButton>
        </div>
        <Divider />
        <List
        subheader={
          <ListSubheader className={classes.listSubHeader} component="div" id="nested-list-subheader">
            ...
            <b>tiger Version:</b> v{tigerVersion}<br/>
            <b>UI Version:</b> v{tigerUIVersion}<br/>
            </div>
            
            <ListItem button component={Link} to='/new' key={"home"} onClick={handleDrawerClose}>
              <ListItemIcon ><SpaceDashboardTwoToneIcon fontSize={"large"} className="tigerElement" /></ListItemIcon>
              ...
              <Collapse in={openGlobal} unmountOnExit>
                <List component="div" disablePadding>
                  ...
                  <ListItem button className={classes.nested} target="_blank" component={Link} to='/jupyter' key={"jupyter"} onClick={handleDrawerClose}>
                    <ListItemIcon><CodeIcon fontSize={"large"} className="tigerElement"/></ListItemIcon>
                  ...
                  <ListItem button className={classes.nested} target="_blank" component={Link} to='/console' key={"console"} onClick={handleDrawerClose}>
                    <ListItemIcon><StorageIcon fontSize={"large"} className="tigerElement"/></ListItemIcon>
                  ...
                  <ListItem button className={classes.nested} component={Link} to='/new/consuming_services' key={"consuming"} onClick={handleDrawerClose}>
                    <ListItemIcon><PublicIcon fontSize={"large"} className="tigerElement"/></ListItemIcon>
              ...
              <Collapse in={openCreate} unmountOnExit>
                  <List component="div" disablePadding>
                    <ListItem button className={classes.nested} component={Link} to='/new/createpayload' key={"createpayload"} onClick={handleDrawerClose} state={{from: 'TopAppBar'}}>
                      <ListItemIcon><PostAddIcon fontSize={"large"} className="tigerElement"/></ListItemIcon>
              ...
              <Collapse in={openOperations} unmountOnExit>
                <List component="div" disablePadding>
                  <ListItem button className={classes.nested} component={Link} to='/new/payloadtypes' key={"payloadtypes"} onClick={handleDrawerClose}>
                    <ListItemIcon><HeadsetTwoToneIcon fontSize={"large"} className="tigerElement"/></ListItemIcon>
                    ...
                    <ListItem button className={classes.nested} component={Link} to='/new/operations' key={"modifyoperations"} onClick={handleDrawerClose}>
                      <ListItemIcon><EditIcon fontSize={"large"} className="tigerElement"/></ListItemIcon>
              ...
              <Collapse in={openData} unmountOnExit>
                <List component="div" disablePadding>
                    ...
                    <ListItem button className={classes.nested} component={Link} to='/new/search?tab=callbacks&searchField=Host&search=' key={"search"} onClick={handleDrawerClose}>
                      <ListItemIcon><SearchIcon fontSize={"large"} className="tigerElement"/></ListItemIcon>
                      <ListItemText primary={"Search"} />
                    </ListItem>
                </List>
              </Collapse>
                <ListItem button component={Link} to='/new/callbacks' key={"callbacks"} onClick={handleDrawerClose}>
                  <ListItemIcon><PhoneCallbackIcon fontSize={"large"} className="tigerElement"/></ListItemIcon>

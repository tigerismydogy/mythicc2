...
function TokenTableRow(props){
    ...
    return (
        <React.Fragment>
            <TableRow hover>
                <tigerConfirmDialog onClose={() => {setOpenDeleteDialog(false);}} onSubmit={onAcceptDelete} open={openDeleteDialog} acceptText={props.deleted ? "Restore" : "Hide" }/>
                
                <tigerStyledTableCell>{props.deleted ? (
                    <tigerStyledTooltip title="Restore Token for use in Tasking">
                    ...
                    <tigerStyledTooltip title="Delete Token so it can't be used in Tasking">
                ...
                <Typography variant="body2" style={{wordBreak: "break-all", display: "inline-block"}}>{props.user}</Typography>
                    <IconButton onClick={() => setEditUserDialog(true)} size="small"><EditIcon /></IconButton>
                        <tigerDialog fullWidth={true} maxWidth="md" open={editUserDialog} 
                ...
                <tigerStyledTableCell >
                    ...
                    <tigerStyledTooltip title="View Token Information"><IconButton size="small" color="primary" onClick={()=>{setViewTokenDialog(true);}}><ConfirmationNumberIcon/></IconButton></tigerStyledTooltip>
                    <tigerDialog fullWidth={true} maxWidth="md" open={viewTokenDialog} 
                ...
                <tigerStyledTableCell>
                    ...
                    <IconButton onClick={() => setEditDescriptionDialog(true)} size="small"><EditIcon /></IconButton>
                        <tigerDialog fullWidth={true} maxWidth="md" open={editDescriptionDialog} 
                ...
                <tigerStyledTableCell>{props.callbacktokens?.map( (cbt) => (
                    <React.Fragment>

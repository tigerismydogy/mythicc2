    ...
    return (
        <React.Fragment>
            <TableRow hover>
                ...
                {fileHistoryDialogOpen && <tigerDialog fullWidth={true} maxWidth="md" open={fileHistoryDialogOpen}
                        ...
                        <>
                            {props.callback?.tigertree_groups.length > 0 ? (
                                <Typography variant="body2" style={{wordBreak: "break-all"}}>
                                    <b>Groups: </b>{props?.callback.tigertree_groups.join(", ")}
                                </Typography>
                            ) : null}
                ...
                <tigerStyledTableCell>
                    {props.filemeta.length > 0 ? (
                        <tigerStyledTooltip title="View Download History and Download Files">

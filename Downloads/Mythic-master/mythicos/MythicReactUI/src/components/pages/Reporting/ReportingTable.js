    ...
    useSubscription(generatedReportSubscription, {
        ...
        onSubscriptionData: ({subscriptionData}) => {
            if(subscriptionData?.data?.operationeventlog_stream?.length > 0){
                ...
                snackActions.success(<tigerSnackDownload title="Download Generated Report" file_id={dataUUID} />, {toastId: dataUUID, autoClose: false, closeOnClick: false});
            }
        }
    });
                                ...
                                <Table>
                                    <TableBody>
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <tigerTextField onChange={changeExcludedCallbackUser} value={excludedCallbackUser} name={"Excluded Usernames"}/>
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>Exclude Hosts</TableCell>
                                            <TableCell>
                                                <tigerTextField onChange={changeExcludedCallbackHost} value={excludedCallbackHost} name={"Excluded Hostnames"}/>
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>Exclude IDs</TableCell>
                                            <TableCell>
                                                <tigerTextField onChange={changeExcludedCallbackID} value={excludedCallbackID} name={"Excluded Callback IDs"}/>
                                            </TableCell>
                                        </TableRow>
                                    </TableBody>

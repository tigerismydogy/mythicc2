        ...
        <React.Fragment>
            <TableRow key={"payload" + props.uuid} hover>
                <tigerStyledTableCell>
                  {props.deleted ? (
                    <tigerStyledTooltip title={"Mark payload as not deleted so you can get callbacks, but does not recreate the payload on disk"}>
                    ...
                    <React.Fragment>
                      <tigerStyledTooltip title={"Delete the payload from disk and mark as deleted. No new callbacks can be generated from this payload"}>
                ...
                <tigerStyledTableCell><Button ref={dropdownAnchorRef} size="small" onClick={()=>{setOpenUpdateDialog(true);}} color="primary" variant="contained">Actions</Button>
                ...
                {openDescription &&
                    <tigerDialog fullWidth={true} maxWidth="md" open={openDescription} 
                ...
                {openFilename &&
                    <tigerDialog fullWidth={true} maxWidth="md" open={openFilename} 
                ...
                {openConfigCheckDialog &&
                    <tigerDialog fullWidth={true} maxWidth="lg" open={openConfigCheckDialog} 
                ...
                {openRedirectRulesDialog &&
                    <tigerDialog fullWidth={true} maxWidth="lg" open={openRedirectRulesDialog} 
                ...
                {openGenerateIOCDialog &&
                    <tigerDialog fullWidth={true} maxWidth="lg" open={openGenerateIOCDialog}
                ...
                {openGenerateSampleMessageDialog &&
                    <tigerDialog fullWidth={true} maxWidth="lg" open={openGenerateSampleMessageDialog}
                ...
                {openCreateNewCallbackDialog &&
                  <tigerDialog fullWidth={true} maxWidth="lg" open={openCreateNewCallbackDialog} 
                ...
                <tigerStyledTableCell>{b64DecodeUnicode(props.filemetum.filename_text)}</tigerStyledTableCell>
                <tigerStyledTableCell>{props.description}</tigerStyledTableCell>
                <tigerStyledTableCell>
            ...
            <TableRow>
            {openDetailedView ? (
              <tigerDialog fullWidth={true} maxWidth="lg" open={openDetailedView} 

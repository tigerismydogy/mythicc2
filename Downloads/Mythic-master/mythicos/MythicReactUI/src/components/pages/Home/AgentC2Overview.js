...
export function AgentC2Overview(props){
    ...
    <div style={{ marginTop: "10px", marginRight: "5px"}}>
                  ...
                  <TableRow key={payload.name} hover>
                    ...
                    {c2Profiles.map( (c2) => (
                      <TableCell key={'payload' + c2}>
                        ...
                        <tigerStyledTooltip title={payload.name + " supports " + c2}>
        ...
        {wrappers.length > 0 && 
          <TableContainer component={Paper} className="tigerElement" style={{marginTop: "10px"}}>   
              <Table  size="small">
                  <TableHead>
                      <TableRow hover>
                          <TableCell></TableCell>
                        ...
                        <TableRow key={'wrapper' + payload.name} hover>
                          ...
                          {payloadTypeRows.map( (wr) => (
                            <TableCell key={'payload' + wr.name}>
                              ...
                              <tigerStyledTooltip title={payload.name + " wraps " + wr.name}>
                                  <CheckCircleIcon color="success"/>
                              </tigerStyledTooltip>
                          : ""}
                            </TableCell>

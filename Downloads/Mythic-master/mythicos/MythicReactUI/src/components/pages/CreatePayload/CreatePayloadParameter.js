...
export function CreatePayloadParameter({onChange, parameter_type, default_value, name, required, verifier_regex, id, description, initialValue, choices, trackedValue, returnAllDictValues}){
    ...
    const getParameterObject = () => {
        switch(parameter_type){
            ...
            case "File":
                return (
                    <>
                        ...
                        {fileValue.legacy &&
                            <tigerFileContext agent_file_id={fileValue.name} />
                        }
                    </>
                            ...
                            <TableBody>
                                {arrayValue.map( (a, i) => (
                                    <TableRow key={'array' + name + i} style={{}} >
                                        ...
                                        <tigerStyledTableCell>
                                            <tigerTextField required={required} fullWidth={true} placeholder={""} value={a} multiline={true}
                                ...
                                <TableRow >
                                    <tigerStyledTableCell style={{width: "3rem"}}>
                                    ...
                                    <TableRow key={'typedarray' + name + i} >
                                        ...
                                        <tigerStyledTableCell>
                                            <div style={{display: "inline-flex", alignItems: "center", width: "100%"}}>
                                                ...
                                                <tigerTextField required={required} fullWidth={true} placeholder={""} value={a[1]} multiline={true}
            ...
            case "String":
                return (
                    <tigerTextField required={required} value={value} multiline={true}
            ...
            case "Number":
                return (
                    <tigerTextField required={required} value={valueNum} type={"number"}
    ...
    return (
            <TableRow key={"buildparam" + id}>
                <TableCell>
                    <tigerStyledTooltip title={name.length > 0 ? name : "No Description"}>
                        {description}
                        {modifiedValue() ? (

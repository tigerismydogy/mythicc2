...
export function Step5Build(props){
    ...
    const finished = async () => {
        ...
        snackActions.info("Submitted Creation to tiger...", {autoClose: 1000});
    ...
    return (
        <div >
            ...
            <br/>
            <tigerTextField onEnter={finished} autoFocus={true} required={false} placeholder={"Filename"} value={filename} multiline={false} onChange={onChangeFilename} display="inline-block"/>
            <tigerTextField onEnter={finished} required={false} placeholder={"description"} value={description} multiline={false} onChange={onChangeDescription} display="inline-block"/>

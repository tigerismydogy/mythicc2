...
import {classes, StyledButton, StyledDivider} from '../../tigerComponents/tigerTransferList';
  ...
  return (
    <React.Fragment>
        ...
        <DialogContent dividers={true} style={{height: "100%", display: "flex", flexDirection: "column", position: "relative",  maxHeight: "100%"}}>
          This will add or remove commands associated with this callback from tiger's perspective. 
          This does NOT add or remove commands within the payload itself that's beaconing out to tiger.

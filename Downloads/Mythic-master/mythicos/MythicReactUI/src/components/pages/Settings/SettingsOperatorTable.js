...
export function SettingsOperatorTable(props){
    ...
    return (
        ...
        <Paper elevation={5} style={{backgroundColor: theme.pageHeader.main, color: theme.pageHeaderText.main, marginBottom: "5px", marginTop: "10px", marginRight: "5px"}} variant={"elevation"}>
            ...
            <tigerStyledTooltip title={"Adjust Global Settings"} style={{float: "right", marginRight: "10px", marginLeft: "5px"}}>
            ...
            {showDeleted ? (
                <tigerStyledTooltip title={"Hide Deleted Operators"} style={{float: "right"}}>
                ...
                <tigerStyledTooltip title={"Show Deleted Operators"} style={{float: "right"}}>
            ...
            {openGlobalSettingsDialog &&
                <tigerDialog open={openGlobalSettingsDialog} size={"lg"} fullWidth

...
var filesBackupCmd = &cobra.Command{
	Use:   "files {path}",
	Short: "backup the various files uploaded/downloaded with tiger",
	Long:  `Run this command to backup the uploaded/downloaded files associated with tiger (Save a copy to the specified location).`,
	Run:   fileBackup,

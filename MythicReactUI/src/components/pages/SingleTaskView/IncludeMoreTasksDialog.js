  ...
  return (
    <React.Fragment>
        ...
        <React.Fragment>
            ...
            <tigerTextField type="number" value={beforeCount} onChange={(name, value, error)=>setBeforeCount(value)} name={"Number of tasks before"} />
            <tigerTextField type="number" value={afterCount} onChange={(name, value, error)=>setAfterCount(value)} name={"Number of tasks after"} />
            <React.Fragment>
                <FormControl style={{width:"100%"}}>
            ...
            {searchTerm === 'operator' ? (
                <tigerTextField multiline={false} onChange={(name, value, error)=>{setOperator(value)}} value={operator} name={"Operator Username"}/>
            ) : null}

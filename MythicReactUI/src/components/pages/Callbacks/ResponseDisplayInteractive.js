...
const InteractiveTaskingBar = ({task, taskData, useASNIColor, toggleANSIColor,
    ...
    return (
        <>
            ...
            <tigerTextField autoFocus={true} maxRows={5} multiline={true} onChange={onInputChange} onEnter={submitTask}
            ...
            <tigerStyledTooltip title={useASNIColor ?  "Disable ANSI Color" : "Enable ANSI Color"} >
            ...
            <tigerStyledTooltip title={showTaskStatus ?  "Hide Task Status" : "Show Task Status"} >
            ...
            <tigerStyledTooltip title={wrapText ?  "Unwrap Text" : "Wrap Text"} >

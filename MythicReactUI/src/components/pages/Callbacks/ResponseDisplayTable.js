...
import { tigerViewJSONAsTableDialog, tigerDialog } from '../../tigerComponents/tigerDialog';
  ...
  return (
    <div style={{...(cellData?.cellStyle || null)}}>
      {cellData?.copyIcon? 
        ...
        </tigerStyledTooltip> : null}
      {cellData?.startIcon? 
        <tigerStyledTooltip title={cellData?.startIconHoverText || ""} >
      ...
      {cellData?.plaintextHoverText? (
        <tigerStyledTooltip title={cellData.plaintextHoverText}>
      ...
      {cellData?.endIcon? 
       <tigerStyledTooltip title={cellData?.endIconHoverText || ""}>
  ...
  const getButtonObject = () => {
    switch(cellData.button.type.toLowerCase()){
      case "dictionary":
        return (
          <React.Fragment>
            <tigerStyledTooltip title={cellData?.button?.hoverText || " "} >
            ...
            {openButton &&
                <tigerDialog fullWidth={true} maxWidth="lg" open={openButton} 
                    onClose={()=>{setOpenButton(false);}} 
                    innerDialog={<tigerViewJSONAsTableDialog title={cellData?.button?.title || "Title Here"} leftColumn={cellData?.button?.leftColumnTitle || "Left Column"} 
      ...
      case "string":
        return (
          <React.Fragment>
            ...
            {openButton &&
                <tigerDisplayTextDialog fullWidth={true} maxWidth="lg" open={openButton} title={cellData?.button?.title || "Title Here"} value={cellData?.button?.value || ""}
                    onClose={()=>{setOpenButton(false);}}
                />
              }
          </React.Fragment>
      ...
      case "table": 
        return (
          <React.Fragment>
            ...
            {openButton &&
                <tigerDialog fullWidth={true} maxWidth="xl" open={openButton} 
                    onClose={()=>{setOpenButton(false);}} 
                        ...
                        <ClickAwayListener onClickAway={handleClose}>
                          <MenuList id="split-button-menu"  >
                            {cellData.button.value.map((option, index) => (
                              ...
                              >
                                <tigerStyledTooltip title={option?.hoverText || (option.type === "task" ? "Task an Agent" : "Display Data")}>

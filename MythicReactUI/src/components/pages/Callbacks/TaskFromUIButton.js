    ...
    return (
        <div>
            {openSelectCommandDialog && 
                <tigerDialog fullWidth={true} maxWidth="md" open={openSelectCommandDialog}
                        onClose={()=>{setOpenSelectCommandDialog(false);onTasked({tasked: false});}} 
                        innerDialog={<tigerSelectFromListDialog onClose={()=>{setOpenSelectCommandDialog(false);onTasked({tasked: false});}}
            ...
            {openSelectCallback &&
                <tigerDialog fullWidth={true} maxWidth="md" open={openSelectCallback}
                              onClose={()=>{setOpenSelectCallback(false);onTasked({tasked: false});}}
                              innerDialog={<tigerSelectFromListDialog onClose={()=>{setOpenSelectCallback(false);onTasked({tasked: false});}}
            ...
            {openCallbackTokenSelectDialog &&
                <tigerDialog fullWidth={true} maxWidth="lg" open={openCallbackTokenSelectDialog}
                    onClose={()=>{setOpenCallbackTokenSelectDialog(false);onTasked({tasked: false});}}
                    innerDialog={<tigerSelectFromListDialog onClose={()=>{setOpenCallbackTokenSelectDialog(false);onTasked({tasked: false});}}
            ...
            {openConfirmDialog && 
                <tigerConfirmDialog onClose={onCancelConfirm} dontCloseOnSubmit={true} onSubmit={onSubmitConfirm} open={openConfirmDialog} acceptText={acceptText}/>
            }
        </div>
    )
}

...
import {tigerTextEditDialog} from "../../tigerComponents/tigerTextEditDialog";
    ...
    return (
        <React.Fragment>
            <TableRow hover>
                ...
                <tigerStyledTableCell>
                    <tigerStyledTooltip title={"Copy to clipboard"} style={{display: "inline-block"}}>
                ...
                <tigerStyledTableCell >
                    <Typography variant="body2" style={{wordBreak: "break-all", whiteSpace: "pre-wrap", display: "inline-block"}}>
                        ...
                        {openDisplayKeylogData &&
                            <tigerDialog maxWidth={"100%"} fullWidth={true} open={openDisplayKeylogData} onClose={() => {setOpenDisplayKeylogData(false);}}
                                  innerDialog={
                                <tigerTextEditDialog fullWidth open={openDisplayKeylogData} onClose={() => {setOpenDisplayKeylogData(false);}}

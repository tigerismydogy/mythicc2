...
import {TagsDisplay} from '../../tigerComponents/tigerTag';
...
import {deleteTagMutation} from '../../tigerComponents/tigerTag';
    ...
    return (
        <React.Fragment>
            <TableRow hover>
                ...
                <tigerStyledTableCell>{props.source}</tigerStyledTableCell>
                <tigerStyledTableCell style={{wordBreak: "break-all"}}><TagTableRowElement {...props} /></tigerStyledTableCell>
            </TableRow>
            {openDeleteDialog &&
                <tigerConfirmDialog onClose={() => {setOpenDeleteDialog(false);}}
                ...
                <TableContainer component={Paper} className="tigerElement" >
                    <Table stickyHeader size="small" style={{"tableLayout": "fixed", "maxWidth": "100%", "overflow": "scroll"}}>
                        <TableBody>
                            <TableRow hover>
                                ...
                                <TableCell>{props.tigertree.tree_type === "file" ? <b>File Browser</b> : <b>Process Browser</b>}</TableCell>
                            </TableRow>
                            <TableRow hover>
                                <TableCell >Name</TableCell>
                                <TableCell>{props.tigertree.name_text}</TableCell>
                            </TableRow>
                            <TableRow hover>
                                <TableCell>
                                    {props.tigertree.tree_type === "file" ? (
                                        "Path"
                                    ) : (
                                        "PID"
                                    )}
                                </TableCell>
                                <TableCell>{props.tigertree.full_path_text}</TableCell>
                            </TableRow>
                            <TableRow hover>
                                <TableCell>Host</TableCell>
                                <TableCell>{props.tigertree.host}</TableCell>
                            </TableRow>
                            <TableRow hover>
                                <TableCell>Comment</TableCell>
                                <TableCell>{props.tigertree.comment}</TableCell>
                            </TableRow>
                            <TableRow hover>
                    ...
                    {viewPermissionsDialogOpen &&
                        <tigerDialog fullWidth={true} maxWidth="md" open={viewPermissionsDialogOpen}
                                      ...
                                      innerDialog={<tigerViewJSONAsTableDialog title="View Permissions Data"
                                                                                leftColumn="Permission" rightColumn="Value"
                                                                                value={props.tigertree.metadata}
                                                                                onClose={()=>{setViewPermissionsDialogOpen(false);}} />}
                        />
                    }
                </TableContainer>

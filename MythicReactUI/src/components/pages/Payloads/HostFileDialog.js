    ...
    <React.Fragment>
        ...
        <DialogContent dividers={true}>
            <Table size="small" aria-label="details" style={{ "overflowWrap": "break-word"}}>
                <TableBody>
                    <TableRow hover>
                        <tigerTableCell>File</tigerTableCell>
                        <tigerTableCell style={{wordBreak: "all"}}>{props.file_name}</tigerTableCell>
                    </TableRow>
                    <TableRow hover>
                        <tigerTableCell>C2 Profile</tigerTableCell>
                        <tigerTableCell>
                    ...
                    <TableRow hover>
                        <tigerTableCell style={{width: "20%"}}>Hosting URL Path (with /)</tigerTableCell>
                        <tigerTableCell>
                            <tigerTextField value={message} onChange={onChangeHostURL} requiredValue={true} >
                            </tigerTextField>
                        </tigerTableCell>
                    </TableRow>
                </TableBody>

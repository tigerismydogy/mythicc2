    ...
    return (
        <div style={{display: "flex", flexDirection: "column", height: "100%"}}>
            <Paper elevation={5} style={{backgroundColor: theme.pageHeader.main, color: theme.pageHeaderText.main,marginBottom: "5px", marginTop: "10px"}} variant={"elevation"}>
                ...
                {showDeleted ? (
                    <tigerStyledTooltip title={"Hide Deleted Services"} style={{float: "right"}}>
                    ...
                    <tigerStyledTooltip title={"Show Deleted Services"} style={{float: "right"}}>
            ...
            <div style={{display: "flex", flexGrow: 1, overflowY: "auto"}}>
                <TableContainer component={Paper} className="tigerElement">
                    <Table size="small" style={{ "maxWidth": "100%", "overflow": "scroll"}}>
                        <TableHead>
                            <TableRow>
                                <tigerTableCell style={{width: "4rem"}}>Delete</tigerTableCell>
                                <tigerTableCell style={{width: "90px"}}></tigerTableCell>
                                <tigerTableCell>Service</tigerTableCell>
                                <tigerTableCell style={{width: "4rem"}}>Type</tigerTableCell>
                                <tigerTableCell>Metadata</tigerTableCell>
                                <tigerTableCell>Status</tigerTableCell>
                                <tigerTableCell style={{width: "12rem"}}>Actions</tigerTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>

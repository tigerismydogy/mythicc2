...
type tigerRPCFileCreateMessage struct {
...
type tigerRPCFileCreateMessageResponse struct {
...
func init() {
	RabbitMQConnection.AddRPCQueue(RPCQueueStruct{
		...
		Queue:      tiger_RPC_FILE_CREATE,
		RoutingKey: tiger_RPC_FILE_CREATE,
		Handler:    processtigerRPCFileCreate,
	})
}

// Endpoint: tiger_RPC_FILE_CREATE
//
...
func tigerRPCFileCreate(input tigerRPCFileCreateMessage) tigerRPCFileCreateMessageResponse {
	response := tigerRPCFileCreateMessageResponse{
		Success: false,
	}
	var err error
...
func processtigerRPCFileCreate(msg amqp.Delivery) interface{} {
	incomingMessage := tigerRPCFileCreateMessage{}
	responseMsg := tigerRPCFileCreateMessageResponse{
		Success: false,
	}
	if err := json.Unmarshal(msg.Body, &incomingMessage); err != nil {
		...
		return tigerRPCFileCreate(incomingMessage)
	}
	return responseMsg
}

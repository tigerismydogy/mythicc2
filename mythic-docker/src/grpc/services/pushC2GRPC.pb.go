...
// this is all normal c2 profiles pass along to tiger anyway
...
// tiger sends along success/error information if any
// tiger sends along the messages
type PushC2MessageFromtiger struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PushC2MessageFromtiger) Reset() {
	*x = PushC2MessageFromtiger{}
	if protoimpl.UnsafeEnabled {
...
func (x *PushC2MessageFromtiger) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PushC2MessageFromtiger) ProtoMessage() {}

func (x *PushC2MessageFromtiger) ProtoReflect() protoreflect.Message {
	mi := &file_pushC2GRPC_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PushC2MessageFromtiger.ProtoReflect.Descriptor instead.
func (*PushC2MessageFromtiger) Descriptor() ([]byte, []int) {
	return file_pushC2GRPC_proto_rawDescGZIP(), []int{1}
}

func (x *PushC2MessageFromtiger) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *PushC2MessageFromtiger) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *PushC2MessageFromtiger) GetMessage() []byte {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *PushC2MessageFromtiger) GetTrackingID() string {
	if x != nil {
		return x.TrackingID
	}
	return ""
...
var file_pushC2GRPC_proto_goTypes = []interface{}{
	...
	(*PushC2MessageFromtiger)(nil), // 1: pushC2Services.PushC2MessageFromtiger
}
var file_pushC2GRPC_proto_depIdxs = []int32{
	...
	1, // 2: pushC2Services.PushC2.StartPushC2Streaming:output_type -> pushC2Services.PushC2MessageFromtiger
	1, // 3: pushC2Services.PushC2.StartPushC2StreamingOneToMany:output_type -> pushC2Services.PushC2MessageFromtiger
...
func file_pushC2GRPC_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pushC2GRPC_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PushC2MessageFromtiger); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

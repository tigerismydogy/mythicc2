...
type PushC2_StartPushC2StreamingClient interface {
	...
	Recv() (*PushC2MessageFromtiger, error)
	grpc.ClientStream
}
...
func (x *pushC2StartPushC2StreamingClient) Recv() (*PushC2MessageFromtiger, error) {
	m := new(PushC2MessageFromtiger)
...
func (x *pushC2StartPushC2StreamingOneToManyClient) Recv() (*PushC2MessageFromtiger, error) {
	m := new(PushC2MessageFromtiger)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type PushC2_StartPushC2StreamingServer interface {
	Send(*PushC2MessageFromtiger) error
...
func (x *pushC2StartPushC2StreamingServer) Send(m *PushC2MessageFromtiger) error {
...
func (x *pushC2StartPushC2StreamingOneToManyServer) Send(m *PushC2MessageFromtiger) error {
	return x.ServerStream.SendMsg(m)
}
